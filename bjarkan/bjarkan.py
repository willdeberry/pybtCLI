...
def pair( args ):
    return format_results( Device().pair_device( args.device ), args.json )



def unpair( args ):
    return format_results( Device().unpair_device( args.device ), args.json )



def connect( args ):
    return format_results( Device().connect_device( args.device ), args.json )



def disconnect( args ):
    return format_results( Device().disconnect_device( args.device ), args.json )
